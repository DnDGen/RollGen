...
namespace RollGen.Tests.Unit.PartialRolls
{
    ...
    public class d20Tests
    {
        ...
        public void IfQuantityOverLimit_ThrowArgumentException()
        {
            ...
            Assert.That(() => partialRoll.d20(), Throws.InstanceOf<ArgumentException>().With.Message.EqualTo("Die roll of 1000001d20 is too large for RollGen"));
        }
        ...
        public void IfAllInputsEqualToLimits_Roll()
        {
            ...
            mockRandom.Setup(r => r.Next(20)).Returns(19);

            var roll = partialRoll.d20();
            Assert.That(roll, Is.EqualTo(Limits.Quantity * 20));
        }
    }
}