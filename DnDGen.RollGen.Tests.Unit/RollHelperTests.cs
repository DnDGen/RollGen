...
namespace DnDGen.RollGen.Tests.Unit
{
    ...
    public class RollHelperTests
    {
        ...
        [TestCase(70_000, 840_000, "7777d100+4d20+1d2+62218")]
        [TestCase(90_210, 90_210, "90210")]
        public void GetRollWithPerfectDistribution_AllowNonstandard(int lower, int upper, string expectedRoll)
        {
        ...
        [TestCase(12, 19, 36, "(1d6-1)*3+1d3+6")]
        [TestCase(15, 22, 45, "(1d12-1)*2+1d2+6")]
        public void GetRollWithPerfectDistribution_WithBaseAmount_AllowNonstandard(int baseAmount, int lower, int upper, string expectedRoll)
        {
            var roll = RollHelper.GetRollWithPerfectDistribution(baseAmount, lower, upper, true);
            Assert.That(roll, Is.EqualTo(expectedRoll));
        }
    }
}
