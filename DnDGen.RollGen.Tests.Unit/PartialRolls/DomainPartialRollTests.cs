...
namespace DnDGen.RollGen.Tests.Unit.PartialRolls
{
    ...
    public class DomainPartialRollTests
    {
        ...
        {
            BuildPartialRoll("4d3k2");
            mockExpressionEvaluator.Setup(e => e.IsValid("5")).Returns(true);
        ...
        [Test]
        public void ReturnAsIndividualRollsFromQuantityExpression_NoRoll_Int_MultipleRolls()
        {
            BuildPartialRoll("4d3k2");
            mockExpressionEvaluator.Setup(e => e.Evaluate<int>("5+1")).Returns(6);
            mockExpressionEvaluator.Setup(e => e.IsValid("5+1")).Returns(true);
        ...
        [Test]
        public void ReturnAsIndividualRollsFromQuantityExpression_NoRoll_Int_SingleRoll()
        {
            BuildPartialRoll("4d3k2+1");
            mockExpressionEvaluator.Setup(e => e.Evaluate<int>("5+1")).Returns(6);
            mockExpressionEvaluator.Setup(e => e.IsValid("5+1")).Returns(true);

            var rolls = partialRoll.AsIndividualRolls();
            Assert.That(rolls.Count(), Is.EqualTo(1));
            Assert.That(rolls.Single(), Is.EqualTo(6));
        }
        ...
        {
            BuildPartialRoll("4d3k2");
            mockExpressionEvaluator.Setup(e => e.IsValid("4")).Returns(true);
        ...
        {
            BuildPartialRoll("4d3k2");
            mockExpressionEvaluator.Setup(e => e.IsValid("2")).Returns(true);
        ...
        {
            BuildPartialRoll("4d3k2");
            mockExpressionEvaluator.Setup(e => e.IsValid("6")).Returns(true);
        ...
        public void ReturnNumericKeepingWithQuantityExpression()
        {
            ...
            mockExpressionEvaluator.Setup(e => e.IsValid("quantity expression")).Returns(true);
        ...
        {
            BuildPartialRoll(9266);
            mockExpressionEvaluator.Setup(e => e.IsValid("7")).Returns(true);
        ...
        public void ParantheticalExpression(string expression, int expectedSum)
        {
            ...
            mockExpressionEvaluator.Setup(e => e.IsValid("1")).Returns(true);
            mockExpressionEvaluator.Setup(e => e.IsValid("1+1")).Returns(true);
            mockExpressionEvaluator.Setup(e => e.IsValid("3")).Returns(true);
            mockExpressionEvaluator.Setup(e => e.IsValid("2")).Returns(true);
            mockExpressionEvaluator.Setup(e => e.IsValid("3+1")).Returns(true);
            mockExpressionEvaluator.Setup(e => e.IsValid("9+1")).Returns(true);
            mockExpressionEvaluator.Setup(e => e.IsValid("9")).Returns(true);
        ...
        [Test]
        public void IsValid_ChecksRepeatedRoll_Valid()
        {
            BuildPartialRoll("9266d9010+42d600+42d600+1337d1336");
        ...
        [Test]
        public void IsValid_ChecksRepeatedRoll_Invalid()
        {
            BuildPartialRoll("9266d9010+42d600+42d600++1337d1336");
            mockExpressionEvaluator.Setup(e => e.IsValid("83486660+50400++1786232")).Returns(false);
        ...
        [Test]
        public void IsValid_ChecksMultipleRepeatedRolls_Valid()
        {
            BuildPartialRoll("9266d9010+42d600+42d600+1337d1336+1337d1336+96d783");
            mockExpressionEvaluator.Setup(e => e.IsValid("83486660+50400+3572464+75168")).Returns(true);
        ...
        [Test]
        public void IsValid_ChecksMultipleRepeatedRolls_Invalid()
        {
            BuildPartialRoll("9266d9010+42d600+42d600+1337d1336+1337d1336++96d783");
            mockExpressionEvaluator.Setup(e => e.IsValid("83486660+50400+3572464++75168")).Returns(false);
        ...
        [Test]
        public void AsSum_ChecksRepeatedRoll()
        {
            BuildPartialRoll("9266d9010+42d600+42d600+1337d1336");
        ...
        [Test]
        public void AsSum_ChecksRepeatedRoll_AvoidOverflow()
        {
            var repeatedRoll = string.Join("+", Enumerable.Repeat("10000d10000", 22));
            BuildPartialRoll($"9266d9010+{repeatedRoll}-1000000000");
        ...
        [Test]
        public void AsSum_ChecksMultipleRepeatedRolls()
        {
            BuildPartialRoll("9266d9010+42d600+42d600+1337d1336+1337d1336+96d783");
            mockExpressionEvaluator.Setup(e => e.Evaluate<int>("40627451+25914+1788903+31440")).Returns(8245);
        ...
        [Test]
        public void AsAverage_ChecksRepeatedRoll()
        {
            BuildPartialRoll("9266d9010+42d600+42d600+1337d1336");
        ...
        [Test]
        public void AsAverage_ChecksMultipleRepeatedRolls()
        {
            BuildPartialRoll("9266d9010+42d600+42d600+1337d1336+1337d1336+96d783");
            mockExpressionEvaluator.Setup(e => e.Evaluate<double>("41747963+25242+1787569+37632")).Returns(8245);
        ...
        [Test]
        public void AsMax_ChecksRepeatedRoll()
        {
            BuildPartialRoll("9266d9010+42d600+42d600+1337d1336");
        ...
        [Test]
        public void AsMax_ChecksMultipleRepeatedRolls()
        {
            BuildPartialRoll("9266d9010+42d600+42d600+1337d1336+1337d1336+96d783");
            mockExpressionEvaluator.Setup(e => e.Evaluate<int>("83486660+50400+3572464+75168")).Returns(8245);
        ...
        [Test]
        public void AsMin_ChecksRepeatedRoll()
        {
            BuildPartialRoll("9266d9010+42d600+42d600+1337d1336");
        ...
        [Test]
        public void AsMin_ChecksMultipleRepeatedRolls()
        {
            BuildPartialRoll("9266d9010+42d600+42d600+1337d1336+1337d1336+96d783");
            mockExpressionEvaluator.Setup(e => e.Evaluate<int>("9266+84+2674+96")).Returns(8245);
