...
namespace DnDGen.RollGen.Tests.Integration
{
    ...
    public class RollTests : IntegrationTests
    {
        ...
        [TestCase("1d2", 2, 1_000_000)]
        [TestCase("(1d2)", 2, 1_000_000)]
        [TestCase("((1d2))", 2, 1_000_000)]
        [TestCase("1d2+3", 1, 1_000_000)]
        [TestCase("1d2+3d4", 1, 1_000_000)]
        [TestCase("(1d2)+(3d4)", 1, 1_000_000)]
        [TestCase("(1d2)d3", 2, 1_000_000)]
        [TestCase("1d(2d3)", 2, 1_000_000)]
        [TestCase("1d2+1", 1, 1_000_000)]
        [TestCase("(1d2+1)", 1, 1_000_000)]
        [TestCase("(1d2)+1", 1, 1_000_000)]
        [TestCase("(1d2+1)+1", 1, 1_000_000)]
        [TestCase("((1d2+1))", 1, 1_000_000)]
        [TestCase("((1d2+1)+1)", 1, 1_000_000)]
        [TestCase("((1d2+1))+1", 1, 1_000_000)]
        [TestCase("((1d2+1)+1)+1", 1, 1_000_000)]
        [TestCase("((1d2)+1)", 1, 1_000_000)]
        [TestCase("((1d2)+1)+1", 1, 1_000_000)]
        [TestCase("((1d2))+1", 1, 1_000_000)]
        [TestCase("(1d2+1)+(3d4+1)", 1, 1_000_000)]
        [TestCase("(1d2+1)+(3d4)+1", 1, 1_000_000)]
        [TestCase("(1d2+1)+(3d4+1)+1", 1, 1_000_000)]
        [TestCase("(1d2+1)+1+(3d4+1)", 1, 1_000_000)]
        [TestCase("(1d2+1)+1+(3d4)+1", 1, 1_000_000)]
        [TestCase("(1d2+1)+1+(3d4+1)+1", 1, 1_000_000)]
        [TestCase("(1d2)+1+(3d4+1)", 1, 1_000_000)]
        [TestCase("(1d2)+1+(3d4)+1", 1, 1_000_000)]
        [TestCase("(1d2)+1+(3d4+1)+1", 1, 1_000_000)]
        [TestCase("(1d2+1)d3", 1, 1_000_000)]
        [TestCase("1d(2d3+1)", 2, 1_000_000)]
        [TestCase("6d5d4k3d2k1", 2, 1_000_000)]
        [TestCase("6d5d4k(3d2k1)", 2, 1_000_000)]
        [TestCase("6d(5d4k3)d2k1", 2, 1_000_000)]
        [TestCase("1+2-(3*4/5)%6", 2, 1_000_000)]
        [TestCase("7d6k5", 1, 1_000_000)]
        [TestCase("1d3!", 2, 1_000_000)]
        [TestCase("2d3!", 1, 1_000_000)]
        [TestCase("1-2+3(4)", 1, 1_000_000)]
        [TestCase("1-2+3(4d5)", 1, 1_000_000)]
        [TestCase("(1)(2)(3)", 1, 1_000_000)]
        [TestCase("(1d2!+3)+(6d5k4)", 1, 1_000_000)]
        [TestCase("(3)d(2)k(1)", 2, 1_000_000)]
        ...
        [TestCase("1d2", "1d2", 20_000, 1_000_000)]
        [TestCase("(1d2)", "1d2+3", 20_000, 1_000_000)]
        [TestCase("((1d2))", "(1d2+3d4)", 20_000, 1_000_000)]
        [TestCase("1d2+3", "(1d2)d3", 10_000, 1_000_000)]
        [TestCase("1d2+3d4", "1d(2d3)", 10_000, 1_000_000)]
        [TestCase("(1d2)+(3d4)", "1d2+1", 10_000, 1_000_000)]
        [TestCase("(1d2)d3", "(1d2+1)+1", 20_000, 1_000_000)]
        [TestCase("1d(2d3)", "((1d2+1)+1)+1", 20_000, 1_000_000)]
        [TestCase("1d2+1", "(1d2+1)+(3d4+1)", 10_000, 1_000_000)]
        [TestCase("(1d2+1)", "(1d2+1)+(3d4+1)+1", 10_000, 1_000_000)]
        [TestCase("(1d2)+1", "(1d2+1)+1+(3d4+1)+1", 10_000, 1_000_000)]
        [TestCase("(1d2+1)+1", "(1d2+1)d3", 10_000, 1_000_000)]
        [TestCase("((1d2+1))", "1d(2d3+1)", 10_000, 1_000_000)]
        [TestCase("((1d2+1)+1)", "6d5d4k3d2k1", 10_000, 1_000_000)]
        [TestCase("((1d2+1))+1", "6d5d4k(3d2k1)", 10_000, 1_000_000)]
        [TestCase("((1d2+1)+1)+1", "1+2-(3*4/5)%6", 10_000, 1_000_000)]
        [TestCase("((1d2)+1)", "7d6k5", 10_000, 1_000_000)]
        [TestCase("((1d2)+1)+1", "1d3!", 10_000, 1_000_000)]
        [TestCase("((1d2))+1", "2d3!", 10_000, 1_000_000)]
        [TestCase("(1d2+1)+(3d4+1)", "1-2+3(4)", 10_000, 1_000_000)]
        [TestCase("(1d2+1)+(3d4)+1", "1-2+3(4d5)", 10_000, 1_000_000)]
        [TestCase("(1d2+1)+(3d4+1)+1", "(1)(2)(3)", 10_000, 1_000_000)]
        [TestCase("(1d2+1)+1+(3d4+1)", "(1d2!+3)+(6d5k4)", 10_000, 1_000_000)]
        [TestCase("(1d2+1)+1+(3d4)+1", "(3)d(2)k(1)", 10_000, 1_000_000)]
        [TestCase("(1d2+1)+1+(3d4+1)+1", "1d2", 10_000, 1_000_000)]
        [TestCase("(1d2)+1+(3d4+1)", "(1d2)", 10_000, 1_000_000)]
        [TestCase("(1d2)+1+(3d4)+1", "((1d2))", 10_000, 1_000_000)]
        [TestCase("(1d2)+1+(3d4+1)+1", "1d2+3", 10_000, 1_000_000)]
        [TestCase("(1d2+1)d3", "1d2+3d4", 10_000, 1_000_000)]
        [TestCase("1d(2d3+1)", "(1d2)+(3d4)", 20_000, 1_000_000)]
        [TestCase("6d5d4k3d2k1", "(1d2)d3", 20_000, 1_000_000)]
        [TestCase("6d5d4k(3d2k1)", "1d(2d3)", 20_000, 1_000_000)]
        [TestCase("6d(5d4k3)d2k1", "1d2+1", 20_000, 1_000_000)]
        [TestCase("1+2-(3*4/5)%6", "(1d2+1)", 20_000, 1_000_000)]
        [TestCase("7d6k5", "(1d2+1)+1", 10_000, 1_000_000)]
        [TestCase("1d3!", "((1d2+1))", 20_000, 1_000_000)]
        [TestCase("2d3!", "((1d2+1))+1", 10_000, 1_000_000)]
        [TestCase("1-2+3(4)", "((1d2+1)+1)", 10_000, 1_000_000)]
        [TestCase("1-2+3(4d5)", "((1d2+1)+1)+1", 10_000, 1_000_000)]
        [TestCase("(1)(2)(3)", "((1d2)+1)", 10_000, 1_000_000)]
        [TestCase("(1d2!+3)+(6d5k4)", "(1d2+1)+(3d4+1)", 10_000, 1_000_000)]
        [TestCase("(3)d(2)k(1)", "(1d2+1)+(3d4)+1", 20_000, 1_000_000)]
